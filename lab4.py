...
users = [
    {'login': 'alex', 'password': '123','name':'алекс', 'sex':'мужской'},
    {'login': 'bob', 'password': '555','name':'боб', 'sex':'мужской'},
    {'login': 'peter', 'password': '789','name':'питер', 'sex':'мужской'},
    {'login': 'huch', 'password': '098','name':'хучч', 'sex':'женский'}
]
