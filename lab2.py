...
'''
cats = [
    {"name": "Британская короткошерстная кошка", "image": "lab2/british_shorthair.jpg", "description": "Британская короткошерстная кошка — это одна из самых популярных пород кошек в мире. Она известна своей спокойной и дружелюбной натурой."},
    {"name": "Сиамская кошка", "image": "lab2/siamese.jpg", "description": "Сиамская кошка — это активная и общительная порода, известная своим голосом и яркой внешностью."},
    {"name": "Мейн-кун", "image": "lab2/maine_coon.jpg", "description": "Мейн-кун — это одна из самых крупных пород кошек, известная своей дружелюбной натурой и длинной шерстью."},
    {"name": "Рэгдолл", "image": "lab2/ragdoll.jpg", "description": "Рэгдолл — это спокойная и ласковая порода, известная своей мягкой и пушистой шерстью."},
    {"name": "Бенгальская кошка", "image": "lab2/bengal.jpg", "description": "Бенгальская кошка — это активная и любознательная порода, известная своим экзотическим внешним видом и игривой натурой."}
]
